...
export default function Home() {
  ...
  return (
   ...
   <div className="col-span-4 md:col-span-1 h-full border-r border-black">
    <ThreeTexts t1="Hi There ! . I am Akash ." t2="Developer, Problem Solver, Tech Blogger and a loving Human." t4="I am a software engineer passionate about dev, design and performance. I believe in non-linear thinking, the beauty in chaos and absurdity, and the importance of empathy as a human."></ThreeTexts>
   </div>
