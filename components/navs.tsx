    ...
    return (
        <div className="ml-2 mt-4 w-[20vw] gap-2 md:gap-0 p-3 font-semibold font-instru text-xl">
            <div className="flex items-center md:justify-start justify-center mb-2 ">
                ...
                <span className={`font-instru p-1 m-0 hover:text-red-500 ${pathname === "/" ? 'text-red-500' : ''}`}>
                    <Link href="/">Home</Link>
                </span>
            </div>
            <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 ${pathname === "/about" ? 'text-red-500' : ''}`}>
            ...
            <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 ${pathname === "/ed" ? 'text-red-500' : ''}`}>
            ...
            <div className="flex items-center md:justify-start justify-center mb-2 ">
                ...
                <span className={`f p-1 m-0 hover:text-red-500 ${pathname === "/pros" ? 'text-red-500' : ''}`}>
            ...
            <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 ${pathname === "/skill" ? 'text-red-500' : ''}`}>
         ...
         <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 ${pathname === "/exp" ? 'text-red-500' : ''}`}>
            ...
            <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 text-center md:text-left ${pathname === "/curric" ? 'text-red-500' : ''}`}>
            ...
            <div className="flex items-center md:justify-start justify-center mb-2">
                ...
                <span className={` p-1 m-0 hover:text-red-500 ${pathname === "/extras" ? 'text-red-500' : ''}`}>
