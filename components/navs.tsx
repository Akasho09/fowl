...
export default function NavBar (){
    ...
    <span className="font-mono font-semibold p-0 m-0 text-red-500"><a href="/">Home</a></span>
    </div>
    <div className="flex items-center ">
    <div className="h-5 w-5 border border-black rounded-full flex items-center justify-center m-2 font-lora">2</div>
    <span className="font-mono font-semibold p-0 m-0 hover:text-red-600"><a href="/ed">Education</a></span>
    </div>
    <div className="flex items-center ">
    <div className="h-5 w-5 border border-black rounded-full flex items-center justify-center m-2 font-lora">3</div>
    <span className="font-mono font-semibold p-0 m-0 hover:text-red-600"><a href="/pros">Projects</a></span>
    </div>
    <div className="flex items-center ">
    <div className="h-5 w-5 border border-black rounded-full flex items-center justify-center m-2 font-lora">4</div>
    <span className="font-mono font-semibold p-0 m-0 hover:text-red-600"><a href="/skill">Skills</a></span>
    </div>
    <div className="flex items-center ">
    <div className="h-5 w-5 border border-black rounded-full flex items-center justify-center m-2 font-lora">5</div>
    <span className="font-mono font-semibold p-0 m-0 hover:text-red-600"><a href="/extra">Extra Curicullars</a></span>
    </div>
    <div className="flex items-center ">
    <div className="h-5 w-5 border border-black rounded-full flex items-center justify-center m-2 font-lora">5</div>
    <span className="font-mono font-semibold p-0 m-0 hover:text-red-600"><a href="/extras">Extras</a></span>
    </div>
