...
const comps= <div className="flex flex-col gap-8">
  <div className="flex justify-between mx-4"><div className="text-slate-900 font-bold">Data Structures & Algorithms</div>
